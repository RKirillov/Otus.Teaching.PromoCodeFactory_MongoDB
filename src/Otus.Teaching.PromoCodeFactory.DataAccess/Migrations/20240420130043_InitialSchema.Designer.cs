...
namespace Otus.Teaching.PromoCodeFactory.DataAccess.Migrations
{
    ...
    [Migration("20240420130043_InitialSchema")]
            ...
            modelBuilder.Entity("Otus.Teaching.PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BeginDate = new DateTime(2024, 4, 20, 16, 0, 43, 108, DateTimeKind.Local).AddTicks(8925),
                            Code = "OSEN2024",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            EndDate = new DateTime(2024, 4, 21, 16, 0, 43, 108, DateTimeKind.Local).AddTicks(8938),
                        ...
                        new
                        {
                            ...
                            BeginDate = new DateTime(2024, 4, 19, 16, 0, 43, 108, DateTimeKind.Local).AddTicks(8950),
                            Code = "LETO2024",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            EndDate = new DateTime(2024, 4, 22, 16, 0, 43, 108, DateTimeKind.Local).AddTicks(8951),
                            PartnerManagerId = new Guid("451533d5-d8d5-4a11-9c7b-eb9f14e1a32f"),
                        ...
                        new
                        {
                            ...
                            BeginDate = new DateTime(2024, 4, 17, 16, 0, 43, 108, DateTimeKind.Local).AddTicks(8956),
                            Code = "ZIMA2024",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            EndDate = new DateTime(2024, 4, 24, 16, 0, 43, 108, DateTimeKind.Local).AddTicks(8957),
